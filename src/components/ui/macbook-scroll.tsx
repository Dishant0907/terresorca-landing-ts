...
export const MacbookScroll = ({
  ...
  return (
    ...
    >
      ...
      />
      {/* Base area */}
      <div className="h-[32rem] w-[42rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[52rem] bg-[#010101] rounded-2xl p-2 relative"
      >
        <div
          style={{
