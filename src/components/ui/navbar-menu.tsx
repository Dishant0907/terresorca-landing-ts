...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full boder border-transparent backdrop-blur-lg bg-black/10 border-white/[0.2]  shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
